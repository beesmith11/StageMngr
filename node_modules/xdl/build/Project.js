...
let setOptionsAsync = exports.setOptionsAsync = (() => {
  var _ref38 = _asyncToGenerator(function* (projectRoot, options) {
    yield (_User || _load_User()).default.ensureLoggedInAsync();
...
let getUrlAsync = exports.getUrlAsync = (() => {
  var _ref39 = _asyncToGenerator(function* (projectRoot, options = {}) {
    yield (_User || _load_User()).default.ensureLoggedInAsync();
    _assertValidProjectRoot(projectRoot);
...
let startAsync = exports.startAsync = (() => {
  var _ref40 = _asyncToGenerator(function* (projectRoot, options = {}, verbose = true) {
    yield (_User || _load_User()).default.ensureLoggedInAsync();
    _assertValidProjectRoot(projectRoot);
...
let stopAsync = exports.stopAsync = (() => {
  var _ref42 = _asyncToGenerator(function* (projectDir) {
