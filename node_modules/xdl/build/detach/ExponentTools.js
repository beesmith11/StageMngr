...
let setBackgroundImage = (() => {
  var _ref10 = _asyncToGenerator(function* (manifest, projectRoot) {
    var backgroundImageOutputPath = _path.default.join(projectRoot, 'launch_background_image.png');

    var backgroundImageUrl;
    if (manifest.loading && manifest.loading.splash && manifest.loading.splash.image && manifest.loading.splash.image.ios && manifest.loading.splash.image.ios.backgroundImageUrl) {
    ...
    if (backgroundImageUrl) {
      yield saveImageToPathAsync(projectRoot, backgroundImageUrl, backgroundImageOutputPath);
    }
  });
...
let configureIOSIconsAsync = (() => {
  var _ref11 = _asyncToGenerator(function* (manifest, destinationIconPath, projectRoot) {
    if (process.platform !== 'darwin') {
      console.warn('`sips` utility may or may not work outside of macOS');
    }
    ...
    iconSizes.forEach(function (iconSize) {
      ...
      iconResolutions.forEach((() => {
        var _ref12 = _asyncToGenerator(function* (iconResolution) {
  ...
  return function configureIOSIconsAsync(_x19, _x20, _x21) {
...
function setBackgroundColor(manifest, dom) {
  ...
  if (manifest.loading && manifest.loading.splash && manifest.loading.splash.backgroundColor) {
